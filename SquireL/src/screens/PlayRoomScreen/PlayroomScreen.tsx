...
export default function PlayroomScreen({ navigation }: Props) {
  return (
    ...
    >
      <Button size="$4" chromeless onPress={() => navigation.navigate('Puzzle')}>
        <FontAwesomeIcon icon={faPuzzlePiece} style={{ color: '#ff8a01' }} />
      </Button>
      <Button size="$4" chromeless onPress={() => navigation.navigate('DrawingGame')}>
        <Image
      ...
      <Button size="$4" chromeless onPress={() => navigation.getParent()?.navigate('DrawingsBox')}>
        <Image
      ...
      <Button size="$4" chromeless onPress={() => navigation.getParent()?.navigate('Library')}>
        <FontAwesomeIcon icon={faHeadphones} style={{ color: '#ff8a01' }} />
      </Button>
      <Button size="$4" chromeless onPress={() => navigation.getParent()?.navigate('LookAndFind')}>
