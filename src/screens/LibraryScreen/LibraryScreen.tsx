...
export default function LibraryScreen() {
    ...
    () => [
      {
        id: 'odyssees',
        name: 'Les Odyssées',
        image: require('../../assets/images/lesOdyssees.jpg'),
        url: 'https://www.radiofrance.fr/franceinter/podcasts/les-odyssees',
      },
      {
        id: 'bestioles',
        name: 'Bestioles',
        image: require('../../assets/images/bestioles.jpg'),
        url: 'https://www.radiofrance.fr/franceinter/podcasts/bestioles',
      },
      {
        id: 'zinstrus',
        name: 'Les-Zinstrus',
        image: require('../../assets/images/lesZinstrus.jpg'),
        url: 'https://www.radiofrance.fr/francemusique/podcasts/les-zinstrus',
      },
      {
        id: 'caillou',
        name: 'Professeur Caillou',
        image: require('../../assets/images/professeurCaillou.jpg'),
        url: 'https://www.radiofrance.fr/franceinter/podcasts/les-aventures-du-professeur-caillou',
      },
    ],
    [],
  );
  ...
  return (
    <ImageBackground
      source={require('../../assets/images/libraryScreen.png')}
    ...
    >
      ...
      >
        <Tabs.List>
          {podcasts.map((podcast) => (
            <Tabs.Tab
              focusStyle={{ backgroundColor: '$orange10' }}
              key={podcast.id}
              borderColor="#ff8a01"
              value={podcast.id}
            >
